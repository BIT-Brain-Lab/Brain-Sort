...
class Ui_Dialog_TTest(QtGui.QDialog):
    def __init__(self):
        super(Ui_Dialog_TTest,self).__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(91, 121, 74, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.label.setStyleSheet('font-family:Helvetica;font-size:14px;')

        self.lineEdit = QtGui.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(171, 121, 111, 20))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "TTest", None))
