...
class Ui_Dialog(QtGui.QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(91, 111, 54, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.label.setStyleSheet('font-family:Helvetica;font-size:14px;')

        self.lineEdit = QtGui.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(151, 111, 133, 20))
        ...
        self.label_p.setGeometry(QtCore.QRect(91, 141, 54, 16))
        ...
        self.lineEdit_p.setGeometry(QtCore.QRect(151, 141, 133, 20))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "linear", None))
        self.label.setText(_translate("Dialog", "C", None))
        self.label_p.setText(_translate("Dialog", "k fold", None))
