...
class Ui_Dialog_Fisher_score(QtGui.QDialog):
    def __init__(self):
        super(Ui_Dialog_Fisher_score,self).__init__()
        self.setupUi(self)
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(121, 121, 74, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.label.setStyleSheet('font-family:Helvetica;font-size:14px;')


        self.lineEdit = QtGui.QLineEdit(Dialog)
        self.lineEdit.setGeometry(QtCore.QRect(191, 121, 100, 20))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Fisher score", None))
        self.label.setText(_translate("Dialog", "threshold", None))

if __name__ == '__main__':
    app = QtGui.QApplication(sys.argv)
    win = Ui_Dialog_Fisher_score()
    win.show()
    app.exec_()